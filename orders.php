...
date_default_timezone_set("Asia/Phnom_Penh"); // ដាក់ timezone ត្រឹមត្រូវ
$dateNow = date("d-F-Y");   // 09-July-2025
$timeNow = date("g:i A");   // 8:05 PM
  ...
  <table class="table table-striped table-bordered align-middle">
    <thead>
      ...
      <th class="bg-primary text-light">ពេលវេលាម៉ោង</th>
        ...
        <!-- <th class="bg-primary text-light">វិក័យបត្រ</th> -->
...
<tr>
  <td class="text-center"><?= $i++ ?></td>
      ...
      <td class="text-center"><?= $timeNow ?></td>
